...
const generateId = (_gameMode) => {
    ...
    switch(_gameMode){
        ...
        case "vehicles":
            _max = 73
            _avoid = [1, 2, 3, 5, 9, 10, 11, 12, 13, 15, 17, 21, 22, 23, 27, 28, 29, 31, 32, 39, 40, 41, 43, 47, 48, 49, 52, 58, 59, 61, 63, 64, 65, 66, 68 ]
        break
        case "starships":
            _max = 68
            _avoid = [1, 4, 6, 7, 8, 14, 16, 18, 19, 20, 24, 25, 26, 30, 33, 34, 35, 36, 37, 38, 42, 44, 45, 46, 50, 51, 53, 54, 55, 56, 57, 60, 62, 67]
        default:
            _max = 30
    }
    do {
